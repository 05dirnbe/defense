...
\begin{frame}
    ...
    \underline{The goal:} Model the peristalsis that is central to all flow dynamics of \P.

	\underline{The problem:} Hydrodynamics is extremely hard!
	...
	\begin{overprint}
		...
		\begin{block}{\emph{Solution: Go electric!}:}
		  \begin{itemize}
		   \item Augmented 3-element Windkessel model
		   \item Peristaltic pumping is mapped to current controlled voltage sources
		   \item Oscillatory dynamics mimics real flow patterns
		  \end{itemize}
		\end{block}
...
\begin{frame}
	...
	\end{figure}
		...
		\begin{figure}[h]
		     \begin{center}
		      \testbox{\includegraphics[angle=0,clip=true,width= 0.8\onehalf, trim = 0 0 0 0]{./pics/steady.pdf}}
		      \testbox{\includegraphics[angle=0,clip=true,width= 0.8\onehalf, trim = 0 0 0 0]{./pics/transient.pdf}}
		     \end{center}
		\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Example network: A small oscillating tree}
...
\begin{frame}
	\frametitle{Example network: The death of a cycle}
...
\begin{frame}
	\frametitle{Example network: Counter-clockwise flow}
...
\begin{frame}
	\frametitle{Example network: Clockwise flow}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.35\linewidth,keepaspectratio,trim={0 4cm 0 3cm},clip]{./pics/dumbbell/dumbbell_3_1.png}
		\qquad
		\includegraphics[width=0.35\linewidth,keepaspectratio,trim={0 4cm 0 3cm},clip]{./pics/dumbbell/dumbbell_3_1_legend.png}
		\newline
